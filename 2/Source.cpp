...
// Функция обработки клавиш клавиатуры
...
void display()
{
    ...
    //glMatrixMode(GL_PROJECTION); // Перспективная проекция
    glLoadIdentity();
    //gluPerspective(90, 1, 2, 12); // Перспективная проекция
    //glMatrixMode(GL_MODELVIEW); // Перспективная проекция
